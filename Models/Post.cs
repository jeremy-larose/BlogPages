...
namespace BlogProject.Models
{
    public class Post
    {
        ...
        [Required]
        [StringLength(200, ErrorMessage = "The {0} must be greater than {2} but less than {1} characters long.", MinimumLength = 2)]
        ...
        [DataType(DataType.Date),Display(Name="Updated Date")] public DateTime? Updated { get; set; }
